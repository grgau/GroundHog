...
def construct_vocabulary(dataset, oov_rate, level):
    filename = os.path.join(dataset,  'ptb.train.txt')
    fd = open(filename, 'rt')
    txt = fd.read()
    if level == 'words':
        txt = txt.replace('\n', ' \n ')
...
def main(parser):
    ...
    train = grab_text(dataset, 'ptb.train.txt', vocab, oov_default, o.dtype, o.level)
    print 'Constructing valid set'
    valid = grab_text(dataset, 'ptb.valid.txt', vocab, oov_default, o.dtype, o.level)
    print 'Constructing test set'
    test = grab_text(dataset, 'ptb.test.txt', vocab, oov_default, o.dtype, o.level)
    print 'Saving data'
